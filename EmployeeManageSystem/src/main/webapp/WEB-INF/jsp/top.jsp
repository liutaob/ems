...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<span id="logo" style="font-size: 38px;color: white;">
				企业员工管理系统
			</span>
			</td>
			<td class="topbg">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td height="50" class="toplink" align="right">
							<a id="exit" style="cursor: pointer;">
								<i class="layui-icon layui-icon-refresh-3">注销退出</i>
							</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td class="topnavlh" align="left">
										...
										当前用户【${sessionScope.USERS_SESSION.username}】
									</td>
