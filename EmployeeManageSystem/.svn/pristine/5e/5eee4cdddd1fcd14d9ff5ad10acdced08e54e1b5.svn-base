			...
			<td>
				<form id="noticeForm" name="noticeForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
						...
						<tr>
							<td class="font3 fftd">
							公告标题：<input type="text" name="noticeTitle" size="30" id="noticeTitle" /> 
						...
						<tr>
							<td class="font3 fftd">
							发布范围:<select name="deptId" id="depts">
						...
						<tr>
							<td class="font3 fftd">
							<input type="submit" value="发布" class="layui-btn layui-btn-xs">
